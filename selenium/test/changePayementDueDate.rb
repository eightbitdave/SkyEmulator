...
class Viewmybill < Test::Unit::TestCase
  ...
  def test_viewmybill
    ...
    @driver.find_element(:link, "Change payment due date").click

    @wait.until { @driver.page_source.include?("Change payment due date") }

    @driver.save_screenshot('ChangePaymentDueDate.png');
  end
